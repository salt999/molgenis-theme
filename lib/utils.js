        ...
        nodes: [
            {
                ...
                nodes: [
                    {label: `${'optimize'.padEnd(10, ' ')} ${cli.settings.optimize}`},
                ]
            },
            {
            ...
            },
            {
                ...
                nodes: [
                    {label: `${'MG_THEME'.padEnd(10, ' ')} ${cli.settings.MG_THEME}`},
                    {label: `${'MG_HOST'.padEnd(10, ' ')} ${cli.settings.MG_HOST}`},
                    {label: `${'MG_WATCH'.padEnd(10, ' ')} ${cli.settings.MG_WATCH}`},
                ]
            }
        ]
    }
